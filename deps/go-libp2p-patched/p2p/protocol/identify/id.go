...
// LibP2PVersion has been updated for Polkadot support
// https://substrate.dev/rustdocs/v1.0/src/substrate_network_libp2p/behaviour.rs.html#66
const LibP2PVersion = "substrate/1.0"

// ClientVersion is the default user agent.
//
// Deprecated: Set this with the UserAgent option.
var ClientVersion = "parity-polkadot/v0.7.18-fc100e65-x86_64-linux-gnu (unknown)"
...
func NewIDService(ctx context.Context, h host.Host, opts ...Option) *IDService {
	...
	// Turn off push and delta for substrate
